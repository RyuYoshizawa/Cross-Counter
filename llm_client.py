...
# Claude 5系（sonnet-5/opus-5/fable-5）はtemperatureパラメータ自体を廃止しており、
# 付けるとBadRequestError（'temperature is deprecated for this model'）になる。
# 'claude-haiku-4-5'のように末尾が偶然"-5"を含む旧世代モデル名もあるため、
# 単純な部分一致ではなく既知のClaude 5系モデル名の前方一致で判定する。
_NO_TEMPERATURE_MODEL_PREFIXES = ('claude-sonnet-5', 'claude-opus-5', 'claude-fable-5')


def _model_supports_temperature(model: str) -> bool:
    return not model.startswith(_NO_TEMPERATURE_MODEL_PREFIXES)
